...
impl State {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        let render_pipeline = {
            ...
            create_render_pipeline(
                ...
                config.format,
                Some(texture::Texture::DEPTH_FORMAT),
                &[Some(ModelVertex::LAYOUT), Some(InstanceRaw::LAYOUT)],
                shader,
            )
        };
    ...
    fn update(&mut self) {
        ...
        // self.camera_controller.update_camera(self.camera, self.)
        ...
        //     i.rotation = i.rotation * cgmath::Quaternion::from_axis_angle(
        ...
        //     0,
        //     bytemuck::cast_slice(ins.as_slice()),
        // );
    }
    ...
    fn window_event(
        ...
        match event {
            ...
            WindowEvent::CursorMoved { position, .. } => {
                state.camera_controller.handle_mouse(position.x, position.y);
            }
            _ => {}
        }
    }
